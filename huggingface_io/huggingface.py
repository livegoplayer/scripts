...
os.environ['NO_PROXY'] = 'localhost, 127.0.0.1, ::1, ip.cn, chinaz.com, 192.168.0.0/16,  mirrors.cloud.aliyuncs.com, hf-mirror.com,  lfs.huggingface.co, *.s3-accelerate.amazonaws.com, *.amazonaws.com'
